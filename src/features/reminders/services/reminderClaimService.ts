...
type ClaimRow = { delivery_id: string; salon_id: string; appointment_id: string; client_id: string | null; channel: "sms" | "viber"; scheduled_for: string; appointment_start: string; recipient: string; salon_timezone: string; attempt_count: number; lease_expires_at: string; claim_token: string };
